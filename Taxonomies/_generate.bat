...
SET GraphViz_Source_Path="%HOMEPATH%\OneDrive\Data\Graphviz Models\graphviz-models\Taxonomies"
CD %GraphViz_Source_Path%

SET DPI=300

FOR %%F IN (%GraphViz_Source_Path%\system.gv) DO (
	ECHO. 
	ECHO *********************
    ECHO * %%~nF
	ECHO *********************
